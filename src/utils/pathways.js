...
export const PATHWAY_CATALOG = [
  {
    ...
    preferredProducts: [
      { id: "yescarta", trial: "ZUMA-7",          nctId: "NCT03391466", line: "2L+ for primary refractory / early relapse" },
      { id: "breyanzi", trial: "TRANSFORM",       nctId: "NCT03575351", line: "2L+ approved" },
      { id: "kymriah",  trial: "JULIET",          nctId: "NCT02445248", line: "2L+ approved" },
      { id: "epkinly",  trial: "EPCORE-NHL-1",    nctId: "NCT03625037", line: "3L+ approved (bispecific, off-the-shelf SC)" },
      { id: "columvi",  trial: "NP30179",         nctId: "NCT03075696", line: "2L+ approved (fixed-duration bispecific)" },
    ],
  ...
  },
  {
    ...
    preferredProducts: [
      { id: "yescarta", trial: "ZUMA-5",          nctId: "NCT03105336", line: "3L+ approved" },
      { id: "breyanzi", trial: "TRANSCEND-FL",    nctId: "NCT04245839", line: "3L+ approved" },
      { id: "kymriah",  trial: "ELARA",           nctId: "NCT03568461", line: "3L+ approved" },
      { id: "lunsumio", trial: "GO29781",         nctId: "NCT02500407", line: "2L+ approved (no leukapheresis, fixed-duration)" },
      { id: "epkinly",  trial: "EPCORE-NHL-1",    nctId: "NCT03625037", line: "3L+ approved" },
    ],
    source: "NCCN B-Cell Lymphomas Guidelines v3.2024",
    sourceUrl: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1480",
  },
  {
    ...
    preferredProducts: [
      { id: "tecartus", trial: "ZUMA-2", nctId: "NCT02601313", line: "R/R MCL after BTKi exposure" },
    ],
    source: "NCCN B-Cell Lymphomas Guidelines v3.2024",
    sourceUrl: "https://www.nccn.org/guidelines/guidelines-detail?category=1&id=1480",
  },
  {
    ...
    preferredProducts: [
      { id: "breyanzi", trial: "TRANSCEND CLL 004", nctId: "NCT03331198", line: "R/R CLL/SLL after BTKi + venetoclax" },
    ],
  ...
  },
  {
    ...
    preferredProducts: [
      { id: "kymriah",  trial: "ELIANA",  nctId: "NCT02435849", line: "≤25 years, R/R B-ALL" },
      { id: "tecartus", trial: "ZUMA-3",  nctId: "NCT02614066", line: "Adult R/R B-ALL" },
    ],
  ...
  },
  {
    ...
    preferredProducts: [
      { id: "carvykti", trial: "CARTITUDE-1/4", nctId: "NCT04181827", line: "4L+ standard · 1L+ for len-refractory (CARTITUDE-4: NCT04181827)" },
      { id: "abecma",   trial: "KarMMa",        nctId: "NCT03361748", line: "4L+ approved" },
      { id: "tecvayli", trial: "MajesTEC-1",    nctId: "NCT04557098", line: "4L+ BCMA bispecific" },
      { id: "talvey",   trial: "MonumenTAL-1",  nctId: "NCT03399799", line: "4L+ GPRC5D — alt after BCMA failure" },
      { id: "elrexfio", trial: "MagnetisMM-3",  nctId: "NCT04649359", line: "4L+ BCMA bispecific" },
    ],

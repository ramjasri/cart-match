...
export const CENTERS = [
  ...
  { id: "hackensack", name: "Hackensack Meridian John Theurer CC",        city: "Hackensack",   state: "NJ", indications: ["dlbcl", "fl", "mcl", "cll", "all", "mm"], products: ["yescarta", "kymriah", "breyanzi", "tecartus", "abecma", "carvykti"], factAccredited: true, nmdpAffiliated: true, url: "https://www.hackensackmeridianhealth.org" },
  { id: "nyu",        name: "NYU Langone Perlmutter Cancer Center",       city: "New York",     state: "NY", indications: ["dlbcl", "fl", "mcl", "cll", "all", "mm"], products: ["yescarta", "breyanzi", "tecartus", "abecma", "carvykti"], factAccredited: true, nmdpAffiliated: true, url: "https://nyulangone.org/locations/perlmutter-cancer-center" },
  { id: "rwj",        name: "Rutgers Cancer Institute of New Jersey (RWJBarnabas)", city: "New Brunswick", state: "NJ", indications: ["dlbcl", "fl", "mcl", "mm"],         products: ["yescarta", "breyanzi", "abecma", "carvykti"],            factAccredited: true, nmdpAffiliated: true, url: "https://www.cinj.org" },
